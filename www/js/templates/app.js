...
pug_html = pug_html + "star_outline\u003C\u002Fi\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E";
...
pug_html = pug_html + "\u003Ca class=\"mdc-button mdc-button--compact\" style=\"padding: 5px; color: #666;\" id=\"versionButton\"\u003E";
...
pug_html = pug_html + "\u003Ca" + (" class=\"mdc-button mdc-card__action mdc-button--primary\""+" id=\"install_link\""+pug_attr("href", "#!/app/" + app[0].manifest.name + "/install", true, false)) + "\u003E";
;pug_debug_line = 80;pug_debug_filename = "src\u002Ftemplates\u002F\u002Fapp.pug";
pug_html = pug_html + "Install\u003C\u002Fa\u003E\u003C\u002Fsection\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 81;pug_debug_filename = "src\u002Ftemplates\u002F\u002Fapp.pug";
pug_html = pug_html + "\u003Cscript\u003E";
;pug_debug_line = 82;pug_debug_filename = "src\u002Ftemplates\u002F\u002Fapp.pug";
pug_html = pug_html + (null == (pug_interp = "const installURL = \"#!/app/" + app[0].manifest.name + "/install/\"") ? "" : pug_interp) + "\u003C\u002Fscript\u003E";

...
pug_html = pug_html + "\u003Cspan" + (" class=\"material-icons mdc-list-item__end-detail mdc-icon-toggle\""+pug_attr("onclick", 'app_restart(\'' + container.Labels['com.docker.swarm.service.name'] + '\')', true, false)) + "\u003E";
...
pug_html = pug_html + "\u003Cspan" + (" class=\"material-icons mdc-list-item__end-detail mdc-icon-toggle\""+pug_attr("onclick", 'app_uninstall(\'' + container.Labels['com.docker.swarm.service.name'] + '\')', true, false)) + "\u003E";
